...
public class Table extends javax.swing.JFrame {
    ...
    model1.addColumn("NOMOR TELEPON");
    model1.addColumn("KOTA");
...
if(Character.isDigit(b.getKeyChar())){
    ...
    private void initComponents() {
        ...
        kota.setBackground(new java.awt.Color(0, 255, 255));
        kota.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bontang", "Samarinda", "Balikpapan", "Tenggarong" }));
        ...
        ulang.setBackground(new java.awt.Color(51, 255, 51));
        ulang.setText("Ulang");
        ...
        jLabel4.setText("TABEL USER");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/posttest5/logo_unmul.png"))); // NOI18N
